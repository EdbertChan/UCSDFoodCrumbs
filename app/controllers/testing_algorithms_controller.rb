class TestingAlgorithmsController < ApplicationController
  ...
  def index
    ...
    #render json: Places.findPlaces(32.7150,-117.1625,50,"food")
    #render json: Places.findPlaces(37.7833,-122.4167,50,"food")
    #render json: TestingAlgorithm.placesQuery(searchQuery)
  end
